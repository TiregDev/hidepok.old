...
//                            finish();
        ...
        public void sukai() {
            session = new SessionManager(RecyclerViewAdapterPOSTSAYA.this.context);
                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            if(response.equals("belum")){
                                ...
                                Toast.makeText(RecyclerViewAdapterPOSTSAYA.this.context, "Anda menyukai post ini",
                                        Toast.LENGTH_SHORT).show();
//                                context.startActivity(new Intent(context, detail_post_saya.class));
                            }else {
...
//                            JSON_DATA_WEB_CALL();
            ...
            Akses.getInstance(RecyclerViewAdapterPOSTSAYA.this.context).addtoRequestQueue(likeRequest);
        }
    }
