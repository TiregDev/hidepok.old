...
public class AmbulanceFragment extends Fragment {
    ...
    String GET_JSON_DATA_HTTP_URL = "http://hidepok.id/include/jsonData.php?kategori=kuliner";
    ...
    ArrayList<GetDataAdapter> dataAdapter;
    RequestQueue requestQueue ;
    DataParserJSON dataJSON;
        ...
        jsonArrayRequest = new JsonArrayRequest(GET_JSON_DATA_HTTP_URL,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        dataJSON = new DataParserJSON();
                        dataJSON.parsingData(response, dataAdapter, JSON_NAME, JSON_DESKRIPSI, JSON_ALAMAT, JSON_NOTLP);
