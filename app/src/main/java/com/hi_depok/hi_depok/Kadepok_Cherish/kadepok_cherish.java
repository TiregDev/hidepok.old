...
public class kadepok_cherish extends AppCompatActivity {
/*    public void init() {
    ...
    public void gotodonasi() {
        ...
        btn_gotodonasi.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent cherish = new Intent(kadepok_cherish.this, kadepok_donasi.class);
    ...
    /*public void gotovolunteer() {
        ...
        btn_volunteer.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent volunteer = new Intent(kadepok_cherish.this, kadepok_volunteer.class);
    ...
    private void initiatepopup() {
        try {
            LayoutInflater layoutInflater = (LayoutInflater)kadepok_cherish.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            ...
            notif.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    Intent notif = new Intent(kadepok_cherish.this, kadepok_donasi_upload.class);
                    startActivity(notif);
                }
            });
    ...
    public void back_profile(View view) {
        Intent intent = new Intent(kadepok_cherish.this, kadepok.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kadepok_cherish_main);
        ...
        gridview.setAdapter(new kadepok_cherish.ImageAdapter(this));

        gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View v,
                                    int position, long id) {
                Intent next = new Intent(kadepok_cherish.this, kadepok_cherish_panti.class);
                startActivity(next);
            }
        });
