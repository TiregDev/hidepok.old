package com.hi_depok.hi_depok.Fokopok.firebase.adapter;
...
import com.hi_depok.hi_depok.Fokopok.firebase.model.ChatModel;
import com.hi_depok.hi_depok.Fokopok.firebase.util.Util;
...
public class ChatFirebaseAdapter extends FirebaseRecyclerAdapter<ChatModel,ChatFirebaseAdapter.MyChatViewHolder> {
    ...
    public ChatFirebaseAdapter(DatabaseReference ref, String nameUser, ClickListenerChatFirebase mClickListenerChatFirebase) {
        super(ChatModel.class, R.layout.fokopok_item_message_left, ChatFirebaseAdapter.MyChatViewHolder.class, ref);
    ...
    public MyChatViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == RIGHT_MSG){
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.fokopok_item_message_right,parent,false);
            return new MyChatViewHolder(view);
        }else if (viewType == LEFT_MSG){
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.fokopok_item_message_left,parent,false);
            return new MyChatViewHolder(view);
        }else if (viewType == RIGHT_MSG_IMG){
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.fokopok_item_message_right_img,parent,false);
            return new MyChatViewHolder(view);
        }else{
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.fokopok_item_message_left_img,parent,false);
            return new MyChatViewHolder(view);
        }
    }
