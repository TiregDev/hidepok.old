...
public class fragment4 extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View  v = inflater.inflate(R.layout.kadepok_fragment4_activity, null);
        ...
        text+= "Video ini akan memberikan anda tutorial dalam cara menggunakan modul Kadepok ini secara singkat dan menarik dengan gaya motion graphics";
        text+= "</p>" +
                "</body>" +
                "</html>";
