...
public class kadepok_donasi_content extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initiatepopup() {
        try {
            LayoutInflater layoutInflater = (LayoutInflater)kadepok_donasi_content.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
